...
//        cameraScript = GetComponent<ThirdPersonCameraNET>();
    ...
    void Start()
    {
		Debug.Log ("ThirdPersonNetworkBxr, Start:I");
...
//            cameraScript.enabled = false;
    ...
    void Update()
    {
//		Debug.Log ("ThridPersonNetworkBxr, Update:I");
		if (!photonView.isMine)
        {
...
//			Debug.Log ("rotatation: " + transform.rotation.ToString());
        }
    }

    void OnPhotonInstantiate(PhotonMessageInfo info)
    {
		Debug.Log ("ThirdPersonNetworkBxr, OnPhotonInstantiate:I");
		/*
